...
#    print("Existing lock: " + str(existing_lock_pk) + " ct: " + str(ct) )
    try:
...
#            print("  Unable to get content type for lock object, giving up!")
            lock = None
        else:
#            print("existing_lock_pk: " + str(existing_lock_pk) )
